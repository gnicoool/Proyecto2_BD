...
-- Compra_Producto
-- =========================
INSERT INTO Compra_Producto (id_compra, id_producto, cantidad_compra, precio_compra) VALUES
(1, 1, 120, 9.20),
(2, 4, 200, 6.40),
(3, 6, 150, 13.20),
(4, 9, 180, 7.80),
...
-- Venta_Producto 
-- =========================
INSERT INTO Venta_Producto (id_venta, id_producto, cantidad_venta, precio_venta) VALUES
(1, 6, 8, 18.00),
(1, 9, 5, 11.50),
(2, 24, 10, 6.75),
(3, 13, 20, 38.00),
