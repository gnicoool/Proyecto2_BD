...
-- Contraseñas:
--   admin123 / vendedor123 / bodeguero123 / contador123 / supervisor123
-- =========================
INSERT INTO Usuario (nit_empleado, nombre, tel_empleado, correo, contrasena, activo, id_rol) VALUES
('90000001', 'Admin Seed',      '55550001', 'admin@seed.local',      '$2b$12$mdhXmztb1pCgpNGAaDk42OJSOpAdBTFd59t8/68fDmwmrvFp0RVj2', true, 1),
('90000002', 'Vendedor Seed',   '55550002', 'vendedor@seed.local',   '$2b$12$mu7b1hI3F4FtYQPDKK/fWuUUWhQIwYDEUdIgVIJ0zECFxuGNsrmJq', true, 2),
('90000003', 'Bodeguero Seed',  '55550003', 'bodeguero@seed.local',  '$2b$12$PiEWRsgfhgSN2lIzG92AP.ffNCMNgA2za8taXGNaIXuYydpgbTVUe',  true, 3),
('90000004', 'Contador Seed',   '55550004', 'contador@seed.local',   '$2b$12$wG1bvWKqzJxyBZRlq/cXquFgnBd9U6pBnqHyuiYQFB9c1g9WcoD9C',  true, 4),
('90000005', 'Supervisor Seed', '55550005', 'supervisor@seed.local', '$2b$12$00N/JD/F6ouLnw8MRCqaPOsOBqk2yKzvuS8.icGQMBQr.DX/MRwo.',  true, 5)
...
(8,  '2025-12-02 15:08:00', 310.00,  10, '90000002'),
(9,  '2025-12-02 16:45:00', 67.80,   5,  '90000002'),
(10, '2025-12-03 08:05:00', 1240.00, 8,  '90000001'),
(11, '2025-12-03 09:33:00', 58.00,   12, '90000002'),
(12, '2025-12-03 10:50:00', 203.40,  7,  '90000002'),
(13, '2025-12-03 11:17:00', 990.25,  11, '90000001'),
(14, '2025-12-03 12:44:00', 45.00,   19, '90000002'),
(15, '2025-12-03 13:29:00', 332.10,  4,  '90000002'),
(16, '2025-12-03 14:03:00', 76.50,   23, '90000002'),
(17, '2025-12-03 15:51:00', 1548.00, 24, '90000001'),
(18, '2025-12-03 16:10:00', 22.75,   16, '90000002'),
(19, '2025-12-04 08:40:00', 405.60,  26, '90000002'),
(20, '2025-12-04 09:08:00', 188.90,  13, '90000002'),
(21, '2025-12-04 10:35:00', 56.00,   18, '90000002'),
(22, '2025-12-04 11:02:00', 721.45,  15, '90000001'),
(23, '2025-12-04 12:28:00', 134.00,  20, '90000002'),
(24, '2025-12-04 13:14:00', 2899.00, 28, '90000001'),
(25, '2025-12-04 14:50:00', 41.25,   29, '90000002'),
(26, '2025-12-04 15:33:00', 612.80,  17, '90000002'),
(27, '2025-12-04 16:01:00', 98.00,   25, '90000002'),
(28, '2025-12-04 16:40:00', 375.50,  21, '90000002'),
(29, '2025-12-05 08:22:00', 210.00,  30, '90000002'),
(30, '2025-12-05 09:55:00', 1555.30, 1,  '90000001');
...
SELECT setval(
    ...
    COALESCE((SELECT MAX(id_rol) FROM rol), 5)
);
SELECT setval(
